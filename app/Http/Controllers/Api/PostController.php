...
class PostController extends Controller
{
    ...
    public function show(Request $request, Post $post): JsonResponse
    {
        ...
        return response()->json([
            ...
            'new_banner_days' => Setting::newBannerDays(),
            'visible_metrics' => $metricVisibility,
            'payment_methods' => app(\App\Services\ContentPurchaseCheckoutService::class)->availablePaymentMethods(),
            'one_off_purchase' => app(\App\Services\HubService::class)->can('one_off_purchase'),
            'credits_purchase' => true,
            'cash_content_purchase' => app(\App\Services\ContentPurchaseCheckoutService::class)->cashPaymentsAllowed(),
        ]);
    }
